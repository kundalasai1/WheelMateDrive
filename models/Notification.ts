...
schema.index({userId:1,readAt:1,createdAt:-1});export const NotificationModel=(models.Notification??model("Notification",schema)) as MongooseModel<MongooseInferSchemaType<typeof schema>>;
